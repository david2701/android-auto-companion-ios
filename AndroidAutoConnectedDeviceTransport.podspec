Pod::Spec.new do |s|
  s.name             = "AndroidAutoConnectedDeviceTransport"
  s.version          = "3.1.0"
  s.summary          = "Part of Android Auto Companion Library."
  s.description      = "Handles transport of data for Android Auto Companion."
  ...
  s.swift_version    = "5.0"
  s.source_files     = "Sources/AndroidAutoConnectedDeviceTransport/*.swift"
